...
class CLIPForSegmentation(BaseSegmentor):
    def __init__(self, clip_path, name_path, device=torch.device('cuda'),
                    ...
                    pre_adjust_idx=8, post_adjust_idx=3, multi_start_idx=3, multi_end_idx=10, res_cls=0.3):
        ...
        self.net.visual.pre_adjust_idx = pre_adjust_idx
        self.net.visual.post_adjust_idx = post_adjust_idx
        self.net.visual.multi_start_idx = multi_start_idx
        self.net.visual.multi_end_idx = multi_end_idx
    ...
    def forward_feature(self, img, logit_size=None):
        ...
        image_features, out_ies = self.net.encode_image(img, return_all=True)
